...
import sylva.ortools.constraint_solver.search_limit_pb2
...
_CPMODELPROTO.fields_by_name['search_limit'].message_type = sylva.ortools.constraint_solver.search_limit_pb2._SEARCHLIMITPROTO
