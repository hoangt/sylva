...
\begin{DoxyCode}
58     \textcolor{keyword}{def }\_\_iadd\_\_(self, msg):
59         self.status.append((self.time\_stamp(), msg))
...
\begin{DoxyCode}
51     \textcolor{keyword}{def }time\_stamp(self):
52         \textcolor{keywordflow}{return} time.strftime(\textcolor{stringliteral}{"[%a, %d %b %Y %H:%M:%S] "}, time.localtime())
53 
\end{DoxyCode}
