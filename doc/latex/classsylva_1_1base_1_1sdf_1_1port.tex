...
\begin{DoxyCode}
98         \textcolor{keyword}{def }\_\_str\_\_(self):
99             \textcolor{keywordflow}{return} \textcolor{stringliteral}{'SDF port %s index %s type %s count %s'} \(\backslash\)
100                 % (self.name, self.index, self.type, self.count)
101 
\end{DoxyCode}
